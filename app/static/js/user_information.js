...
// クリックされた際にページ遷移
change_user_mail_btn.childNodes[1].onclick = function (){
...
// クリックされた際にページ遷移
change_user_passwd_btn.childNodes[1].onclick = function (){
...
// クリックされた際にログアウト
logout_btn.childNodes[1].onclick = function (){
    document.location.href = '/user_info/logout';
};
